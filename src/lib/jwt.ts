...
// In real firmware v4.0, JWT is generated/verified on the ESP32 with a device
...
export function signJwt(payload: Omit<JwtPayload, 'iat' | 'exp'>, secret: string, ttlSeconds = 3600): string {
